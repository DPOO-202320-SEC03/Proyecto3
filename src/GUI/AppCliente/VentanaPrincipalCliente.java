...
public class VentanaPrincipalCliente extends JFrame{
    ...
    private static PanelNorteCliente panelNorte;
    private static PanelCentralCliente panelCentral;
    ...
    public void cambiarPagina(int paginaNueva) {
        ...
        pagina = paginaNueva;
        panelNorte = new PanelNorteCliente(this, paginaNueva);
        add(panelNorte, BorderLayout.NORTH);
        panelCentral = new PanelCentralCliente(this, paginaNueva);
    ...
    public static void main(String[] args) {
        VentanaPrincipalCliente ventanaPrincipal = new VentanaPrincipalCliente();
    }
